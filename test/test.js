...
var SolidusAssetsProxy = require('../index');

describe('SolidusAssetsProxy', function() {
  describe('.proxyAssets', function() {
    it('replaces assets URLs by proxies URLs', function() {
      var assets_proxy = new SolidusAssetsProxy({
        origins: [
          'http://resource1.com/resource/path',
          /http:\/\/resource(?:2|3)\.com\/resource\/path/
        ],
        proxy: 'http://proxy.com/proxy/path'
      });

      var from = ' \
        http://resource1.com/resource/path/some/image1.jpg \
        http://resource2.com/resource/path/some/image2.jpg \
        http://resource3.com/resource/path/some/image3.jpg';
      var to = ' \
        http://proxy.com/proxy/path/http%3A%2F%2Fresource1.com%2Fresource%2Fpath%2Fsome%2Fimage1.jpg \
        http://proxy.com/proxy/path/http%3A%2F%2Fresource2.com%2Fresource%2Fpath%2Fsome%2Fimage2.jpg \
        http://proxy.com/proxy/path/http%3A%2F%2Fresource3.com%2Fresource%2Fpath%2Fsome%2Fimage3.jpg';
    ...
    it('with invalid URLs', function() {
      var assets_proxy = new SolidusAssetsProxy({
        origins: ['http://resource.com/resource/path'],
        proxy: 'http://proxy.com/proxy/path'
      });

      var from = ' \
        http://resource.com/resource2/path/bad \
        badhttp://resource.com/resource/path/some/image.jpg';
